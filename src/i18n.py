...
_T: dict[str, dict[str, str]] = {
    "en": {
        ...
        "toast.summary_saved": "Weekly summary saved: {path}",
        "toast.summary_empty": "Not enough history yet for a weekly summary.",

        "summary.title": "Weekly usage summary",
        "summary.account": "Account",
        "summary.generated": "Generated",
        "summary.range": "Range (last 7 days)",
    ...
    "th": {
        ...
        "toast.summary_saved": "บันทึกสรุปรายสัปดาห์แล้ว: {path}",
        "toast.summary_empty": "ข้อมูลยังไม่พอสำหรับสรุปรายสัปดาห์",

        "summary.title": "สรุปการใช้งานรายสัปดาห์",
        "summary.account": "บัญชี",
        "summary.generated": "สร้างเมื่อ",
        "summary.range": "ช่วงเวลา (7 วันล่าสุด)",
